...
const Hero = () => {
    return (
        <div key="1" className="bg-[#0c0e16] min-h-screen text-white  font-inter ">
            <Navbar />
            <header className=" text-center pb-80 md:pb-20 max-w-6xl mx-auto px-4 sm:px-6 max-h-screen">
                <h1 className="mx-40 text-5xl md:text-7xl font-extrabold leading-tighter tracking-tighter mb-20">
